...
resgister_button = ctk.CTkButton(master=frame, text="Cadastrar-se", width=150, fg_color="#2B1A1A", hover_color="#2D39334").pack(padx=175, pady= 325) #fg_collor="green"=hover_color="#2D39334"
